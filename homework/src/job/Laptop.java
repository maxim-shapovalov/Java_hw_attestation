...
// —оздание класса Laptop
public class Laptop {
    // —оздание пол€ на основе другого класса
    ...
    // —оздание пустого конструктора дл€ работы с методами
    public Laptop() {
    }
    // —оздание конструктора дл€ создани€ экземпл€ров класса
    ...
    // —оздание методов get\set ƒл€ работы с private пол€ми
    ...
    // —оздание метода дл€ создани€ экземпл€ра другого класса,
// дл€ того что бы работать с этими экземпл€ррами в данном классе
    public void addBrand(Brand brand) {
        brands.add(brand);
    }
    // создание метода фильтрации ноутбуков по критери€м
    public List<Laptop> filter(Set<Laptop> laptop) {
        Scanner scan = new Scanner(System.in);
        System.out.println("«драсвуйте, ”кажите каие параметры дл€ ноут бука вы бы хотели иметь." +
                "\n”кажите размер жЄсткого диска в гб\n¬наличии : 300,500,600,700,1000");
        String enterHardDisk = scan.nextLine();
        int intParseEnterHardDisk = Integer.parseInt(enterHardDisk);
        System.out.println("”кажите количество оперативной пам€ти в √б\n¬наличии : 4, 8, 16 ");
        String enterOperativeMemory = scan.nextLine();
        System.out.println("”кажите операционную систему\n¬наличии : Linux, ios, Windows");
        String enterOperatingSystem = scan.nextLine();
        System.out.println("”кажите цвет ноутбука\n¬наличии : black, white");
    ...
    // создание метода фильтрации ноутбуков по выборочной критери€м
    public Set<Laptop> newFilter(Set<Laptop> laptop) {
        Scanner scan = new Scanner(System.in);
        Set<Laptop> listLaptop = new HashSet<>(laptop);

        System.out.println("«драсвуйте, ”кажите номер или номера критериев фильрации ноутбуков," +
        ...
        for (int i = 0; i < userRequest.length(); i++) {
            if(1 == Character.getNumericValue(userRequest.charAt(i))) {
                System.out.println("”кажите размер жЄсткого диска в гб\n¬наличии : 300,500,600,700,1000");
                String enterHardDisk = scan.nextLine();
                int intParseEnterHardDisk = Integer.parseInt(enterHardDisk);
                for (Laptop tempLaptop : laptop) {
                    if (intParseEnterHardDisk != tempLaptop.hardDisk){
